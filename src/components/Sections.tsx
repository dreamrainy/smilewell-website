...
export function Contact() {
  ...
  return (
    <section ref={ref} id="contact" style={{ padding: "96px 40px", background: "#1B4B6B", color: "white", textAlign: "center" }}>
      ...
      <div className="reveal" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "32px", maxWidth: "700px", margin: "0 auto", borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: "40px" }} className="contact-grid">
        {[
